...
class ApproximaNetMA(nn.Module):
    def __init__(
        ...
        super(ApproximaNetMA, self).__init__()
    ...
    def forward(self, x):
        ...
        out = torch.squeeze(self.queryLayer(out))
